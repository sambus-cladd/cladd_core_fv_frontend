            ...
            <Box component="section" sx={{ px: 0.5, py: 0 }}>
                <Grid container direction="row" justifyContent="center" alignItems="center">
                    ...
                    <Grid container direction="row" justifyContent="flex-start" alignItems="flex-start" px={1}>
                        ...
                        <Grid item xs={6}>
                            <Typography sx={{ fontSize: 14, fontFamily: 'Poppins', color: '#5B6B7A' }}>Cál: <span style={{ fontWeight: "bold", color: '#1A4862' }}>{!isNaN(calculo) && calculo !== null ? (`${calculo} ${unidadCalculo}`) : ""} </span></Typography>
                        </Grid>
                    </Grid>
                </Grid >
            </Box>
