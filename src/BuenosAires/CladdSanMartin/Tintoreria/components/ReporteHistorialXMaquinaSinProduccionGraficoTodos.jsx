...
function ReporteHistorialXMaquinaSinProduccionGraficoTodos({ Serie }) {
  ...
  Serie.forEach((elemento) => {
    ...
    if (!datosAgrupados[key]) {
      datosAgrupados[key] = {
        fecha: key,
        [idMaquina]: elemento.TiempoSinProduccion,
      };
    } else {
      datosAgrupados[key][idMaquina] = (datosAgrupados[key][idMaquina] || 0) + elemento.TiempoSinProduccion;
    }
  });
...
export default ReporteHistorialXMaquinaSinProduccionGraficoTodos;
