...
function ReporteHistorialXMaquinaTiemposTabla({  Serie,Labels,Titulo,FechaIncio,FechaFin}) {
    ...
    let fila,filas=[];
      ...
      {    
        Serie.map((elemento, index) => 
        {
            ...
            fila = {
                id: index,
                Fecha: `${dia}-${mes}-${anio}`,
                TiempoSinProduccion: (elemento.TiempoSinProduccion).toLocaleString('de-DE'),
                TiempoParos: (elemento.TiempoParos),
                TiempoReal: (elemento.TiempoReal),      
            };
                filas.push(fila);
          }
        )
      ...
      const columns = [
        ...
        { 
          field: 'TiempoSinProduccion', 
          headerName: 'Sin Producción [Min]',
          flex: 1,   
          headerClassName: 'table-header',
          cellClassName: 'table-body',
        },
...
export default ReporteHistorialXMaquinaTiemposTabla