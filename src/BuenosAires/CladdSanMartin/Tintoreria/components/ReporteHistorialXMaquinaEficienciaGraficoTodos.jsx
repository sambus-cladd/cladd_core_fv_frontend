...
function ReporteHistorialXMaquinaEficienciaGraficoTodos({ Serie }) {
  ...
  Serie.forEach((elemento) => {
    ...
    if (!datosAgrupados[key]) {
      datosAgrupados[key] = {
        fecha: key,
        [idMaquina]: elemento.Eficiencia,
      };
    } else {
      datosAgrupados[key][idMaquina] = (datosAgrupados[key][idMaquina] || 0) + elemento.Eficiencia;
    }
  });
...
export default ReporteHistorialXMaquinaEficienciaGraficoTodos;
