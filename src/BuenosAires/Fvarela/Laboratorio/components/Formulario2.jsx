    ...
    return (
        <>
            <div>
                ...
                {/* <Grid xs={12} sm={12} md={12} mb={0.5}>

                </Grid> */}

                <Grid container columns={12} rowSpacing={3} mr={2} ml={2} mt={2} >

                    {/* INICIO CARD DATOS DE CARGA */}
                    <Grid xs={12} sm={12} md={12} m={2} rowSpacing={3}>   {/* <Grid xs={12} sm={12} md={12} m={2} rowSpacing={3} > */}
                        <Card sx={{ minWidth: '90%', borderRadius: "10px", boxShadow: "1px 1px 2px 3px rgba(0, 0, 0, 0.4)" }}>
                            <Grid container columns={12} p={1} columnSpacing={1} rowSpacing={1} m={1}   >
                                {/* TITULO DE CARD */}
                    ...
                    {/* INICIO CARD Nº 2 */}
                    <Grid xs={12} sm={12} md={12} m={2} rowSpacing={3}>
                        <Card p={1} sx={{ minWidth: '90%', borderRadius: "10px", boxShadow: "1px 1px 2px 3px rgba(0, 0, 0, 0.4)" }}>
                            <Grid container columns={12} columnSpacing={0} rowSpacing={3} p={2} mb={0.5} mt={0.5} >
                                ...
                                <Grid xs={3} sm={3} md={3} pr={0.5} pl={0.5} mb={0.5} mt={0.5}>
                                    <FormControl fullWidth>
                                        <InputLabel htmlFor="outlined-TARIMA" required style={{ fontFamily: 'Poppins, sans-serif' }}>Tarima</InputLabel>
                                        <OutlinedInput
                                            id="outlined-TARIMA"
                                            label="Tarima"
                                            // value={MOrden}
                                ...
                                <Grid xs={3} sm={3} md={3} pr={0.5} pl={0.5} mb={0.5} mt={0.5}>
                                    <FormControl fullWidth>
                                        <InputLabel htmlFor="outlined-RUTINA" required style={{ fontFamily: 'Poppins, sans-serif' }}>Rutina</InputLabel>
                                        <OutlinedInput
                                            id="outlined-RUTINA"
                                ...
                                <Grid xs={3} sm={3} md={3} pr={0.5} pl={0.5} mb={0.5} mt={0.5}>
                                    <FormControl fullWidth>
                                        <InputLabel htmlFor="outlined-ARTICULO" required style={{ fontFamily: 'Poppins, sans-serif' }}>Articulo</InputLabel>
                                        <OutlinedInput
                                ...
                                <Grid xs={3} sm={3} md={3} pr={0.5} pl={0.5} mb={0.5} mt={0.5}>
                                    <FormControl fullWidth>
                                        <InputLabel htmlFor="outlined-LOTE" required style={{ fontFamily: 'Poppins, sans-serif' }}>Lote</InputLabel>
                                        <OutlinedInput
                                            id="outlined-LOTE"
                                            // startAdornment={<EMobiledataIcon position="Start" />}
                                            label="LOTE"
                                ...
                                <Grid xs={3} sm={3} md={3} pr={0.5} pl={0.5} mb={0.5} mt={0.5}>
                                    <FormControl fullWidth>
                                        <InputLabel htmlFor="outlined-RUTINA" required style={{ fontFamily: 'Poppins, sans-serif' }}>Longitud Lote</InputLabel>
                                        <OutlinedInput
                                ...
                                <Grid xs={3} sm={3} md={3} pr={0.5} pl={0.5} mb={0.5} mt={0.5}>
                                    <FormControl fullWidth>
                                        <InputLabel htmlFor="outlined-RUTINA" required style={{ fontFamily: 'Poppins, sans-serif' }}>Muestra</InputLabel>
                                        <OutlinedInput
                                            id="outlined-MUESTRA"
                                            // startAdornment={<EMobiledataIcon position="Start" />}
                                            label="Muestra"
                                ...
                                <Grid xs={3} sm={3} md={3} pr={0.5} pl={0.5} mb={0.5} mt={0.5}>
                                    ...
                                    <FormControl fullWidth>
                                        <InputLabel htmlFor="select-label-LIGDIBU" required style={{ fontFamily: 'Poppins, sans-serif' }}> Ligamento | Dibujo </InputLabel>
                                        <Select
                                        ...
                                        >
                                            ...
                                            <MenuItem value={"TM"}>Sarga Z</MenuItem>
                                            <MenuItem value={"TM"}>Sarga S</MenuItem>
                                            <MenuItem value={"TT"}>Saten Z</MenuItem>
                                            <MenuItem value={"TN"}>Saten S</MenuItem>
                                            <MenuItem value={"TM"}>Tafetán</MenuItem>
                                            <MenuItem value={"TT"}>Broken</MenuItem>
                                            <MenuItem value={"TN"}>Convección S</MenuItem>
                                            <MenuItem value={"TN"}>Fantasía</MenuItem>
                                            <MenuItem value={"TM"}>Panamá</MenuItem>
                                            <MenuItem value={"TT"}>Piqué</MenuItem>
                                            <MenuItem value={"TN"}>Reps</MenuItem>
                                        </Select>
                                    </FormControl>
                                ...
                                <Grid xs={3} sm={3} md={3} pr={0.5} pl={0.5} mb={0.5} mt={0.5}>
                                    ...
                                    <FormControl fullWidth>
                                        <InputLabel htmlFor="select-label-OBS" required style={{ fontFamily: 'Poppins, sans-serif' }}>Observaciones</InputLabel>
                                        <Select
                                            labelId="select-label-OBS"
                                            id="select-label-OBS"
                                            // value={ValorTurno}
                                            label="Observaciones"
                                        // onChange={handleSelectTurno}
                                        ...
                                        >
                                            <MenuItem value={-1}>Elegir Opcion</MenuItem>
                                            <MenuItem value={"TM"}>TERMINADO</MenuItem>
                                            <MenuItem value={"TM"}>REPRUEBA</MenuItem>
                                            <MenuItem value={"TT"}>CRUDO</MenuItem>
                                            <MenuItem value={"TN"}>LAV POT</MenuItem>
                                            <MenuItem value={"TM"}>Tafetán</MenuItem>
                                            <MenuItem value={"TT"}>Broken</MenuItem>
                                            <MenuItem value={"TN"}>Convección S</MenuItem>
                                            <MenuItem value={"TN"}>OTRO</MenuItem>
                                            <MenuItem value={"TM"}>3 Ensayos</MenuItem>
                                        </Select>
                                    </FormControl>
                            ...
                            <Grid container columns={12} columnSpacing={1} rowSpacing={3} p={2} mb={0.5} mt={0.5} >
                                ...
                                <Grid xs={3} sm={3} md={3} pl={1} pb={1} sx={{ display: "flex", alignItems: "center", textAlign: "left" }}>
                                    <FormControl sx={{ m: 0 }} style={{ width: '100%' }}>
                                        <InputLabel htmlFor="outlined-Manometro" required style={{ fontFamily: 'Poppins, sans-serif' }}>Ancho sin lavar</InputLabel>
                                        <OutlinedInput
                                ...
                                <Grid xs={3} sm={3} md={3} pl={1} sx={{ display: "flex", alignItems: "center", textAlign: "left" }}>
                                    <FormControl sx={{ m: 0 }} style={{ width: '100%' }}>
                                        <InputLabel htmlFor="outlined-Manometro" required style={{ fontFamily: 'Poppins, sans-serif' }}>Ancho lavado</InputLabel>
                                        <OutlinedInput
                                ...
                                <Grid xs={3} sm={3} md={3} pl={1} sx={{ display: "flex", alignItems: "center", textAlign: "left" }}>
                                    <FormControl sx={{ m: 0 }} style={{ width: '100%' }}>
                                        <InputLabel htmlFor="outlined-Manometro" required style={{ fontFamily: 'Poppins, sans-serif' }}>Peso sin lavar</InputLabel>
                                        <OutlinedInput
                                ...
                                <Grid xs={3} sm={3} md={3} pl={1} sx={{ display: "flex", alignItems: "center", textAlign: "left" }}>
                                    <FormControl sx={{ m: 0 }} style={{ width: '100%' }}>
                                        <InputLabel htmlFor="outlined-Manometro" required style={{ fontFamily: 'Poppins, sans-serif' }}>Recuento Urdido</InputLabel>
                                        <OutlinedInput
                                ...
                                <Grid xs={3} sm={3} md={3} pl={1} mt={1} sx={{ display: "flex", alignItems: "center", textAlign: "left" }}>
                                    <FormControl sx={{ m: 0 }} style={{ width: '100%' }}>
                                        <InputLabel htmlFor="outlined-Manometro" required style={{ fontFamily: 'Poppins, sans-serif' }}>Longitud de Lote</InputLabel>
                                        <OutlinedInput
                                ...
                                <Grid xs={3} sm={3} md={3} pl={1} mt={1} sx={{ display: "flex", alignItems: "center", textAlign: "left" }}>
                                    <FormControl sx={{ m: 0 }} style={{ width: '100%' }}>
                                        <InputLabel htmlFor="outlined-Manometro" required style={{ fontFamily: 'Poppins, sans-serif' }}>Recuento Trama</InputLabel>
                                        <OutlinedInput
                                ...
                                <Grid xs={3} sm={3} md={3} pl={1} mt={1} sx={{ display: "flex", alignItems: "center", textAlign: "left" }}>
                                    <FormControl sx={{ m: 0 }} style={{ width: '100%' }}>
                                        <InputLabel htmlFor="outlined-Manometro" required style={{ fontFamily: 'Poppins, sans-serif' }}>Estabilidad Trama</InputLabel>
                                        <OutlinedInput
                                ...
                                <Grid xs={3} sm={3} md={3} pl={1} mt={1} sx={{ display: "flex", alignItems: "center", textAlign: "left" }}>
                                    <FormControl sx={{ m: 0 }} style={{ width: '100%' }}>
                                        <InputLabel htmlFor="outlined-Manometro" required style={{ fontFamily: 'Poppins, sans-serif' }}>Estabilidad Urdido</InputLabel>
                                        <OutlinedInput
                                ...
                                <Grid xs={3} sm={3} md={3} pl={1} mt={1} sx={{ display: "flex", alignItems: "center", textAlign: "left" }}>
                                    <FormControl sx={{ m: 0 }} style={{ width: '100%' }}>
                                        <InputLabel htmlFor="outlined-Manometro" required style={{ fontFamily: 'Poppins, sans-serif' }}>Predistorsión Izq.</InputLabel>
                                        <OutlinedInput
                                ...
                                <Grid xs={3} sm={3} md={3} pl={1} mt={1} sx={{ display: "flex", alignItems: "center", textAlign: "left" }}>
                                    <FormControl sx={{ m: 0 }} style={{ width: '100%' }}>
                                        <InputLabel htmlFor="outlined-Manometro" required style={{ fontFamily: 'Poppins, sans-serif' }}>Predistorsión Der.</InputLabel>
                                        <OutlinedInput
                                ...
                                <Grid xs={3} sm={3} md={3} pl={1} mt={1} sx={{ display: "flex", alignItems: "center", textAlign: "left" }}>
                                    <FormControl sx={{ m: 0 }} style={{ width: '100%' }}>
                                        <InputLabel htmlFor="outlined-Manometro" required style={{ fontFamily: 'Poppins, sans-serif' }}>Movimiento Izq.</InputLabel>
                                        <OutlinedInput
                                ...
                                <Grid xs={3} sm={3} md={3} pl={1} mt={1} sx={{ display: "flex", alignItems: "center", textAlign: "left" }}>
                                    <FormControl sx={{ m: 0 }} style={{ width: '100%' }}>
                                        <InputLabel htmlFor="outlined-Manometro" required style={{ fontFamily: 'Poppins, sans-serif' }}>Movimiento Der.</InputLabel>
                                        <OutlinedInput
                                ...
                                <Grid xs={3} sm={3} md={3} pl={1} mt={1} sx={{ display: "flex", alignItems: "center", textAlign: "left" }}>
                                    <FormControl sx={{ m: 0 }} style={{ width: '100%' }}>
                                        <InputLabel htmlFor="outlined-Manometro" required style={{ fontFamily: 'Poppins, sans-serif' }}>Elasticidad Lavada</InputLabel>
                                        <OutlinedInput
                                ...
                                <Grid xs={3} sm={3} md={3} pl={1} mt={1} sx={{ display: "flex", alignItems: "center", textAlign: "left" }}>
                                    <FormControl sx={{ m: 0 }} style={{ width: '100%' }}>
                                        <InputLabel htmlFor="outlined-Manometro" required style={{ fontFamily: 'Poppins, sans-serif' }}>Deformación Lavada</InputLabel>
                                        <OutlinedInput
